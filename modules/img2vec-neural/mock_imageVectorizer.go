...
func (_m *MockimageVectorizer) Object(ctx context.Context, object *models.Object, comp moduletools.VectorizablePropsComparator, cfg moduletools.ClassConfig) ([]float32, models.AdditionalProperties, error) {
...
func (_e *MockimageVectorizer_Expecter) Object(ctx interface{}, object interface{}, comp interface{}, cfg interface{}) *MockimageVectorizer_Object_Call {
	return &MockimageVectorizer_Object_Call{Call: _e.mock.On("Object", ctx, object, comp, cfg)}
}

func (_c *MockimageVectorizer_Object_Call) Run(run func(ctx context.Context, object *models.Object, comp moduletools.VectorizablePropsComparator, cfg moduletools.ClassConfig)) *MockimageVectorizer_Object_Call {
