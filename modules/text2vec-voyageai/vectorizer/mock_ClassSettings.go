...
func (_m *MockClassSettings) Truncate() bool {
	ret := _m.Called()
...
func (_c *MockClassSettings_Truncate_Call) Return(_a0 bool) *MockClassSettings_Truncate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClassSettings_Truncate_Call) RunAndReturn(run func() bool) *MockClassSettings_Truncate_Call {
	_c.Call.Return(run)
	return _c
}
