...
func (_m *MockReRankerClient) MetaInfo() (map[string]interface{}, error) {
	ret := _m.Called()
...
// MockReRankerClient_MetaInfo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MetaInfo'
type MockReRankerClient_MetaInfo_Call struct {
	*mock.Call
}

// MetaInfo is a helper method to define mock.On call
func (_e *MockReRankerClient_Expecter) MetaInfo() *MockReRankerClient_MetaInfo_Call {
	return &MockReRankerClient_MetaInfo_Call{Call: _e.mock.On("MetaInfo")}
}

func (_c *MockReRankerClient_MetaInfo_Call) Run(run func()) *MockReRankerClient_MetaInfo_Call {
...
func (_c *MockReRankerClient_MetaInfo_Call) Return(_a0 map[string]interface{}, _a1 error) *MockReRankerClient_MetaInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReRankerClient_MetaInfo_Call) RunAndReturn(run func() (map[string]interface{}, error)) *MockReRankerClient_MetaInfo_Call {
	_c.Call.Return(run)
	return _c
}
