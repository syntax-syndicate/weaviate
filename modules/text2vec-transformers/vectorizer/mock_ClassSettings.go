...
// PoolingStrategy provides a mock function with given fields:
func (_m *MockClassSettings) PoolingStrategy() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PoolingStrategy")
	}
...
// MockClassSettings_PoolingStrategy_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PoolingStrategy'
type MockClassSettings_PoolingStrategy_Call struct {
	*mock.Call
}

// PoolingStrategy is a helper method to define mock.On call
func (_e *MockClassSettings_Expecter) PoolingStrategy() *MockClassSettings_PoolingStrategy_Call {
	return &MockClassSettings_PoolingStrategy_Call{Call: _e.mock.On("PoolingStrategy")}
}

func (_c *MockClassSettings_PoolingStrategy_Call) Run(run func()) *MockClassSettings_PoolingStrategy_Call {
...
func (_c *MockClassSettings_PoolingStrategy_Call) Return(_a0 string) *MockClassSettings_PoolingStrategy_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClassSettings_PoolingStrategy_Call) RunAndReturn(run func() string) *MockClassSettings_PoolingStrategy_Call {
	_c.Call.Return(run)
	return _c
}
