...
func (_m *MockClassSettings) PropertyIndexed(propName string) bool {
...
//   - propName string
func (_e *MockClassSettings_Expecter) PropertyIndexed(propName interface{}) *MockClassSettings_PropertyIndexed_Call {
	return &MockClassSettings_PropertyIndexed_Call{Call: _e.mock.On("PropertyIndexed", propName)}
}

func (_c *MockClassSettings_PropertyIndexed_Call) Run(run func(propName string)) *MockClassSettings_PropertyIndexed_Call {
...
func (_m *MockClassSettings) VectorizePropertyName(propName string) bool {
	ret := _m.Called(propName)
...
//   - propName string
func (_e *MockClassSettings_Expecter) VectorizePropertyName(propName interface{}) *MockClassSettings_VectorizePropertyName_Call {
	return &MockClassSettings_VectorizePropertyName_Call{Call: _e.mock.On("VectorizePropertyName", propName)}
}

func (_c *MockClassSettings_VectorizePropertyName_Call) Run(run func(propName string)) *MockClassSettings_VectorizePropertyName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
