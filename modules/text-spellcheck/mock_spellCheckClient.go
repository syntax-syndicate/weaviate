...
func (_m *MockspellCheckClient) MetaInfo() (map[string]interface{}, error) {
	ret := _m.Called()
...
// MockspellCheckClient_MetaInfo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MetaInfo'
type MockspellCheckClient_MetaInfo_Call struct {
	*mock.Call
}

// MetaInfo is a helper method to define mock.On call
func (_e *MockspellCheckClient_Expecter) MetaInfo() *MockspellCheckClient_MetaInfo_Call {
	return &MockspellCheckClient_MetaInfo_Call{Call: _e.mock.On("MetaInfo")}
}

func (_c *MockspellCheckClient_MetaInfo_Call) Run(run func()) *MockspellCheckClient_MetaInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockspellCheckClient_MetaInfo_Call) Return(_a0 map[string]interface{}, _a1 error) *MockspellCheckClient_MetaInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockspellCheckClient_MetaInfo_Call) RunAndReturn(run func() (map[string]interface{}, error)) *MockspellCheckClient_MetaInfo_Call {
	_c.Call.Return(run)
	return _c
}
