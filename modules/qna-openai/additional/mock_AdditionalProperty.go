...
// AdditionalFieldFn provides a mock function with given fields: classname
func (_m *MockAdditionalProperty) AdditionalFieldFn(classname string) *graphql.Field {
	ret := _m.Called(classname)

	if len(ret) == 0 {
		panic("no return value specified for AdditionalFieldFn")
	}
...
// MockAdditionalProperty_AdditionalFieldFn_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AdditionalFieldFn'
type MockAdditionalProperty_AdditionalFieldFn_Call struct {
	*mock.Call
}

// AdditionalFieldFn is a helper method to define mock.On call
//   - classname string
func (_e *MockAdditionalProperty_Expecter) AdditionalFieldFn(classname interface{}) *MockAdditionalProperty_AdditionalFieldFn_Call {
	return &MockAdditionalProperty_AdditionalFieldFn_Call{Call: _e.mock.On("AdditionalFieldFn", classname)}
}

func (_c *MockAdditionalProperty_AdditionalFieldFn_Call) Run(run func(classname string)) *MockAdditionalProperty_AdditionalFieldFn_Call {
...
func (_c *MockAdditionalProperty_AdditionalFieldFn_Call) Return(_a0 *graphql.Field) *MockAdditionalProperty_AdditionalFieldFn_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAdditionalProperty_AdditionalFieldFn_Call) RunAndReturn(run func(string) *graphql.Field) *MockAdditionalProperty_AdditionalFieldFn_Call {
	_c.Call.Return(run)
	return _c
}
