...
func (_m *MockClassSettings) Endpoint() string {
	ret := _m.Called()
...
// MockClassSettings_Endpoint_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Endpoint'
type MockClassSettings_Endpoint_Call struct {
	*mock.Call
}

// Endpoint is a helper method to define mock.On call
func (_e *MockClassSettings_Expecter) Endpoint() *MockClassSettings_Endpoint_Call {
	return &MockClassSettings_Endpoint_Call{Call: _e.mock.On("Endpoint")}
}

func (_c *MockClassSettings_Endpoint_Call) Run(run func()) *MockClassSettings_Endpoint_Call {
...
func (_c *MockClassSettings_Endpoint_Call) Return(_a0 string) *MockClassSettings_Endpoint_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClassSettings_Endpoint_Call) RunAndReturn(run func() string) *MockClassSettings_Endpoint_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClassSettings) Service() string {
	ret := _m.Called()
...
// MockClassSettings_Service_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Service'
type MockClassSettings_Service_Call struct {
	*mock.Call
}

// Service is a helper method to define mock.On call
func (_e *MockClassSettings_Expecter) Service() *MockClassSettings_Service_Call {
	return &MockClassSettings_Service_Call{Call: _e.mock.On("Service")}
}

func (_c *MockClassSettings_Service_Call) Run(run func()) *MockClassSettings_Service_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockClassSettings_Service_Call) Return(_a0 string) *MockClassSettings_Service_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClassSettings_Service_Call) RunAndReturn(run func() string) *MockClassSettings_Service_Call {
	_c.Call.Return(run)
	return _c
}

// TargetModel provides a mock function with given fields:
func (_m *MockClassSettings) TargetModel() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for TargetModel")
	}
...
// MockClassSettings_TargetModel_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TargetModel'
type MockClassSettings_TargetModel_Call struct {
	*mock.Call
}

// TargetModel is a helper method to define mock.On call
func (_e *MockClassSettings_Expecter) TargetModel() *MockClassSettings_TargetModel_Call {
	return &MockClassSettings_TargetModel_Call{Call: _e.mock.On("TargetModel")}
}

func (_c *MockClassSettings_TargetModel_Call) Run(run func()) *MockClassSettings_TargetModel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockClassSettings_TargetModel_Call) Return(_a0 string) *MockClassSettings_TargetModel_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClassSettings_TargetModel_Call) RunAndReturn(run func() string) *MockClassSettings_TargetModel_Call {
	_c.Call.Return(run)
	return _c
}

// TargetVariant provides a mock function with given fields:
func (_m *MockClassSettings) TargetVariant() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for TargetVariant")
	}
...
// MockClassSettings_TargetVariant_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TargetVariant'
type MockClassSettings_TargetVariant_Call struct {
	*mock.Call
}

// TargetVariant is a helper method to define mock.On call
func (_e *MockClassSettings_Expecter) TargetVariant() *MockClassSettings_TargetVariant_Call {
	return &MockClassSettings_TargetVariant_Call{Call: _e.mock.On("TargetVariant")}
}

func (_c *MockClassSettings_TargetVariant_Call) Run(run func()) *MockClassSettings_TargetVariant_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockClassSettings_TargetVariant_Call) Return(_a0 string) *MockClassSettings_TargetVariant_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClassSettings_TargetVariant_Call) RunAndReturn(run func() string) *MockClassSettings_TargetVariant_Call {
	_c.Call.Return(run)
	return _c
}
