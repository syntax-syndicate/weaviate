...
import (
	...
	ent "github.com/weaviate/weaviate/modules/text2vec-palm/ent"
)
...
// Vectorize provides a mock function with given fields: ctx, input, config, titlePropertyValue
func (_m *MockClient) Vectorize(ctx context.Context, input []string, config ent.VectorizationConfig, titlePropertyValue string) (*ent.VectorizationResult, error) {
	ret := _m.Called(ctx, input, config, titlePropertyValue)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, ent.VectorizationConfig, string) (*ent.VectorizationResult, error)); ok {
		return rf(ctx, input, config, titlePropertyValue)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, ent.VectorizationConfig, string) *ent.VectorizationResult); ok {
		r0 = rf(ctx, input, config, titlePropertyValue)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, ent.VectorizationConfig, string) error); ok {
		r1 = rf(ctx, input, config, titlePropertyValue)
	} else {
		r1 = ret.Error(1)
	}
...
//   - titlePropertyValue string
func (_e *MockClient_Expecter) Vectorize(ctx interface{}, input interface{}, config interface{}, titlePropertyValue interface{}) *MockClient_Vectorize_Call {
	return &MockClient_Vectorize_Call{Call: _e.mock.On("Vectorize", ctx, input, config, titlePropertyValue)}
}

func (_c *MockClient_Vectorize_Call) Run(run func(ctx context.Context, input []string, config ent.VectorizationConfig, titlePropertyValue string)) *MockClient_Vectorize_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string), args[2].(ent.VectorizationConfig), args[3].(string))
	})
	return _c
}
...
func (_c *MockClient_Vectorize_Call) RunAndReturn(run func(context.Context, []string, ent.VectorizationConfig, string) (*ent.VectorizationResult, error)) *MockClient_Vectorize_Call {
	_c.Call.Return(run)
	return _c
}
