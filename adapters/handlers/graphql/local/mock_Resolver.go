...
func (_m *MockResolver) GetClass(ctx context.Context, principal *models.Principal, info dto.GetParams) ([]interface{}, error) {
	ret := _m.Called(ctx, principal, info)
...
// MockResolver_GetClass_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetClass'
type MockResolver_GetClass_Call struct {
	*mock.Call
}
...
//   - principal *models.Principal
//   - info dto.GetParams
func (_e *MockResolver_Expecter) GetClass(ctx interface{}, principal interface{}, info interface{}) *MockResolver_GetClass_Call {
	return &MockResolver_GetClass_Call{Call: _e.mock.On("GetClass", ctx, principal, info)}
}

func (_c *MockResolver_GetClass_Call) Run(run func(ctx context.Context, principal *models.Principal, info dto.GetParams)) *MockResolver_GetClass_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockResolver_GetClass_Call) Return(_a0 []interface{}, _a1 error) *MockResolver_GetClass_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockResolver_GetClass_Call) RunAndReturn(run func(context.Context, *models.Principal, dto.GetParams) ([]interface{}, error)) *MockResolver_GetClass_Call {
	_c.Call.Return(run)
	return _c
}
