...
func idVector(ctx context.Context, id uint64, callerId int) ([]float32, error) {
...
func idVectorSize(size int) func(ctx context.Context, id uint64, callerId int) ([]float32, error) {
	return func(ctx context.Context, id uint64, callerId int) ([]float32, error) {
