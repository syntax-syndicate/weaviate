	...
	for _, stackRecord := range stackRecords {
		if _, ok := p.stacks[stackRecord.Stack0]; !ok {
			...
			for {
				...
				if strings.Contains(frame.File, "cyclemanager") ||
					strings.Contains(frame.Function, "batchWorker") ||
					strings.Contains(frame.Function, "raft") ||
					strings.Contains(frame.Function, "http2") ||
					strings.Contains(frame.Function, "memberlist") ||
					strings.Contains(frame.Function, "selectgo") ||
					strings.Contains(frame.Function, "cluster") ||
					strings.Contains(frame.Function, "rest") ||
					strings.Contains(frame.Function, "signal_recv") ||
					strings.Contains(frame.Function, "backgroundRead") ||
					strings.Contains(frame.Function, "SetupGoProfiling") ||
					strings.Contains(frame.Function, "serve") ||
					strings.Contains(frame.Function, "Serve") {
					continue stackLoop
				}
				if !more {
