...
// VectorizeDepth provides a mock function with given fields: ctx, thermal, cfg
func (_m *MockbindVectorizer) VectorizeDepth(ctx context.Context, thermal string, cfg moduletools.ClassConfig) ([]float32, error) {
...
func (_e *MockbindVectorizer_Expecter) VectorizeDepth(ctx interface{}, thermal interface{}, cfg interface{}) *MockbindVectorizer_VectorizeDepth_Call {
	return &MockbindVectorizer_VectorizeDepth_Call{Call: _e.mock.On("VectorizeDepth", ctx, thermal, cfg)}
}

func (_c *MockbindVectorizer_VectorizeDepth_Call) Run(run func(ctx context.Context, thermal string, cfg moduletools.ClassConfig)) *MockbindVectorizer_VectorizeDepth_Call {
