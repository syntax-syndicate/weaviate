...
// VectorizeIMU provides a mock function with given fields: ctx, video, cfg
func (_m *MockbindVectorizer) VectorizeIMU(ctx context.Context, video string, cfg moduletools.ClassConfig) ([]float32, error) {
...
func (_e *MockbindVectorizer_Expecter) VectorizeIMU(ctx interface{}, video interface{}, cfg interface{}) *MockbindVectorizer_VectorizeIMU_Call {
	return &MockbindVectorizer_VectorizeIMU_Call{Call: _e.mock.On("VectorizeIMU", ctx, video, cfg)}
}

func (_c *MockbindVectorizer_VectorizeIMU_Call) Run(run func(ctx context.Context, video string, cfg moduletools.ClassConfig)) *MockbindVectorizer_VectorizeIMU_Call {
